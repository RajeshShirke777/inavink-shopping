...
@Component({
  selector: 'app-shop-carousel-three',
  templateUrl: './shop-carousel-three.component.html',
  styleUrls: ['./shop-carousel-three.component.scss']
})
export class ShopCarouselThreeComponent implements OnInit {
