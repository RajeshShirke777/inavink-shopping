...
@Component({
  selector: 'app-shipping-and-payments',
  templateUrl: './shipping-and-payments.component.html',
  styleUrls: ['./shipping-and-payments.component.sass']
})
export class ShippingAndPaymentsComponent implements OnInit {
