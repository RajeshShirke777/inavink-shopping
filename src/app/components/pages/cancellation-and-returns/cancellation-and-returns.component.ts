...
@Component({
  selector: 'app-cancellation-and-returns',
  templateUrl: './cancellation-and-returns.component.html',
  styleUrls: ['./cancellation-and-returns.component.sass']
})
export class CancellationAndReturnsComponent implements OnInit {
